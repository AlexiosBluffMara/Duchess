...
Tier 2: Companion Phone (Gemma 3n E2B) → NLU, bilingual alerts, triage
...
2. If PPE violation suspected → frame sent to Tier 2 (phone) for Gemma 3n confirmation
3. If Gemma 3n confirms → video clip immediately sent to cloud for full assessment (skip nightly batch)
...
- **Models**: YOLOv8-nano, MobileNet, Gemma 3n E2B, Qwen2.5-VL-7B/72B
